...
{
    public partial class ModDetect : Form
    {
       //initialize
      ...
      //now initialize a list to save recognized names
        ...
        public ModDetect()
        {
            InitializeComponent();
               ...
               {
                   MessageBox.Show("ATENCIÓN! No hay imágenes registradas.\n Recuerde siempre entrenar el modelo antes de utilizarlo.");
               }
        }
